        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link to={createPageUrl("PrivacyPolicy")} className="text-sm hover:text-blue-400 transition-colors">
                    Privacy Policy
                  </Link>
                </li>
                <li>
                  <Link to={createPageUrl("TermsOfUse")} className="text-sm hover:text-blue-400 transition-colors">
                    Terms of Use
                  </Link>
                </li>
              </ul>
