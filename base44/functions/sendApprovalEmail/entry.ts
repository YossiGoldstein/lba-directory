...
async function sendGmail(accessToken, { to, subject, htmlBody }) {
  ...
  const rawEncoded = toBase64Url(mime);
...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#f1f5f9;padding:32px 0;">
  <tr><td align="center">
    <table role="presentation" width="580" cellpadding="0" cellspacing="0" style="max-width:580px;width:100%;background:#ffffff;border-radius:8px;overflow:hidden;border:1px solid #e2e8f0;">
      ...
      <tr><td style="padding:36px 40px 0;">
        ...
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:6px;margin-bottom:28px;">
          <tr><td style="padding:20px 24px;">
            <p style="margin:0 0 12px;color:#0e4f6e;font-size:13px;font-weight:700;text-transform:uppercase;">Listing Details</p>
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
              <tr>
                <td style="padding:5px 0;color:#6b7280;font-size:14px;width:110px;">Business:</td>
                <td style="padding:5px 0;color:#111827;font-size:14px;font-weight:600;">${business.business_name}</td>
              </tr>
              ${business.phone ? `<tr><td style="padding:5px 0;color:#6b7280;font-size:14px;">Phone:</td><td style="padding:5px 0;color:#111827;font-size:14px;">${business.phone}</td></tr>` : ''}
              ${address ? `<tr><td style="padding:5px 0;color:#6b7280;font-size:14px;">Address:</td><td style="padding:5px 0;color:#111827;font-size:14px;">${address}</td></tr>` : ''}
              <tr>
        ...
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#fffbeb;border:1px solid #fcd34d;border-radius:6px;margin-bottom:28px;">
          <tr><td style="padding:20px 24px;">
            ...
            <p style="margin:0 0 14px;color:#92400e;font-size:14px;line-height:1.6;">We offer professional services to help your business stand out - Logo Design, Website Development, CRM Systems, Promotional Videos, WhatsApp AI Chat, and more.</p>
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
              <tr><td align="center">
      ...
      <tr><td style="background:#1e293b;padding:18px 40px;text-align:center;border-radius:0 0 8px 8px;">
        <p style="margin:0 0 6px;color:#94a3b8;font-size:12px;">LBA Directory - Serving Lakewood, Toms River, Jackson, Brick, Howell and Manchester</p>
